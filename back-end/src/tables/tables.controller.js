...
// checks the length of table name is valid
...
// checks that table capacity is valid
...
// checks that reservation exists
...
// checks that the table has correct capacity
...
// checks if table status is free
function tableFree(req, res, next) {
...
// checks if table status is occupied
...
async function seat(req, res) {
    ...
    // set reservation status to "seated" using reservation_id
...
async function finish(req, res) {
    ...
    // set reservation status to "finished" using reservation_id
    const updatedReservation = {
        status: "finished", 
