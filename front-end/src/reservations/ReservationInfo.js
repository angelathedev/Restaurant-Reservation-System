...
export default function ReservationInfo({ reservation_id, first_name, last_name, mobile_number, reservation_time, people, status }) {
    ...
    return (
        <div className="card mb-3">
            ...
            <p>Reservation Time: {reservation_time}<br />
                Number of People in Party: {people}<br />
